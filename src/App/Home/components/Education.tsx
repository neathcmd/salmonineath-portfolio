  ...
  const educationItems = [
    {
      ...
      description:
        "Graduated with distinction from an intensive graphic design program focusing on digital media, branding, and typography.",
      skills: [
    ...
    },
    {
      ...
      description:
        "Completed advanced coursework in user experience research, interface design, and prototyping methodologies.",
